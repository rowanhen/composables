...
function getPatternStyle(
	...
	if (variant === "dots") {
		...
		return orientation === "horizontal"
			? {
					backgroundImage:
						"radial-gradient(circle, var(--color-border) calc(var(--border-width-base) / 2), transparent 0)",
					backgroundSize:
	...
	return orientation === "horizontal"
		? {
				backgroundImage: `repeating-linear-gradient(to right, var(--color-border) 0, var(--color-border) ${pillLen}, transparent ${pillLen}, transparent ${unit})`,
		...
		: {
				backgroundImage: `repeating-linear-gradient(to bottom, var(--color-border) 0, var(--color-border) ${pillLen}, transparent ${pillLen}, transparent ${unit})`,
