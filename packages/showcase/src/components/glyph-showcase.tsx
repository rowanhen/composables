      ...
      <VStack gap={6}>
        ...
        <VStack gap={2}>
          ...
          <HStack gap={4} wrap>
            <VStack gap={1} align="center">
              <Glyph size={48} variant="default">A</Glyph>
              <Typography variant="caption-100">default</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={48} variant="filled">B</Glyph>
              <Typography variant="caption-100">filled</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={48} variant="circle">C</Glyph>
              <Typography variant="caption-100">circle</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={48} variant="circle-inverted">D</Glyph>
        ...
        <VStack gap={2}>
          ...
          <HStack gap={4} align="end" wrap>
            <VStack gap={1} align="center">
              <Glyph size={16} variant="default">Z</Glyph>
              <Typography variant="caption-100">16</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={24} variant="default">Z</Glyph>
              <Typography variant="caption-100">24</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={32} variant="default">Z</Glyph>
              <Typography variant="caption-100">32</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={48} variant="default">Z</Glyph>
              <Typography variant="caption-100">48</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={64} variant="default">Z</Glyph>
              <Typography variant="caption-100">64</Typography>
            </VStack>
            <VStack gap={1} align="center">
              <Glyph size={96} variant="default">Z</Glyph>
