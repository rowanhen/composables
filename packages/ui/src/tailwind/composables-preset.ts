...
const fontSize: Record<string, [string, { lineHeight: string; letterSpacing: string }]> = {
	'token-xs': [
		'var(--font-size-xs)',
		{ lineHeight: 'var(--line-height-xs)', letterSpacing: 'var(--letter-spacing-xs)' },
	],
	'token-sm': [
		'var(--font-size-sm)',
		{ lineHeight: 'var(--line-height-sm)', letterSpacing: 'var(--letter-spacing-sm)' },
	],
	'token-md': [
		'var(--font-size-md)',
		{ lineHeight: 'var(--line-height-md)', letterSpacing: 'var(--letter-spacing-md)' },
	],
	'token-lg': [
		'var(--font-size-lg)',
		{ lineHeight: 'var(--line-height-lg)', letterSpacing: 'var(--letter-spacing-lg)' },
	],
	'token-xl': [
		'var(--font-size-xl)',
		{ lineHeight: 'var(--line-height-xl)', letterSpacing: 'var(--letter-spacing-xl)' },
	],
	'token-2xl': [
		'var(--font-size-2xl)',
		{ lineHeight: 'var(--line-height-2xl)', letterSpacing: 'var(--letter-spacing-2xl)' },
	],
	'token-3xl': [
		'var(--font-size-3xl)',
		{ lineHeight: 'var(--line-height-3xl)', letterSpacing: 'var(--letter-spacing-3xl)' },
	],
}
