...
import { List, ListArrowItem, ListBulletItem } from '@/components/ui-opinionated/list'
...
export function ListShowcase() {
	return (
		<ShowcaseSection title="List" description="Variant list renderer: arrow and bullet styles.">
			<VStack gap={8}>
					...
					<VStack gap={4}>
						<div className="max-w-sm">
							<List variant="arrow">
								...
								<ListArrowItem
									content={<span className="font-semibold text-primary">Highlighted item C</span>}
								/>
							</List>
						</div>
						<div className="max-w-sm">
