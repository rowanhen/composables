...
export const colorTokens: FlatToken[] = [
	...
	{
		cssVar: '--surface-success-hover',
		reference: '{green.200}',
		category: 'interactive',
		label: 'surface-success-hover',
	},
	{
		cssVar: '--surface-success-active',
		reference: '{green.300}',
		category: 'interactive',
		label: 'surface-success-active',
	},
	{
		cssVar: '--surface-warning-hover',
		reference: '{orange.200}',
		category: 'interactive',
		label: 'surface-warning-hover',
	},
	{
		cssVar: '--surface-warning-active',
		reference: '{orange.300}',
		category: 'interactive',
		label: 'surface-warning-active',
	},
	{
		cssVar: '--surface-info-hover',
		reference: '{sky.200}',
		category: 'interactive',
		label: 'surface-info-hover',
	},
	{
		cssVar: '--surface-info-active',
		reference: '{sky.300}',
		category: 'interactive',
		label: 'surface-info-active',
	},
	{
		cssVar: '--surface-brand-hover',
		reference: '{pink.200}',
		category: 'interactive',
		label: 'surface-brand-hover',
	},
	{
		cssVar: '--surface-brand-active',
		reference: '{pink.300}',
		category: 'interactive',
		label: 'surface-brand-active',
	},
	{
		cssVar: '--surface-emphasis-hover',
		reference: '{blue.200}',
		category: 'interactive',
		label: 'surface-emphasis-hover',
	},
	{
		cssVar: '--surface-emphasis-active',
		reference: '{blue.300}',
		category: 'interactive',
		label: 'surface-emphasis-active',
	},
	{
		cssVar: '--surface-critical-hover',
		reference: '{red.200}',
		category: 'interactive',
		label: 'surface-critical-hover',
	},
	{
		cssVar: '--surface-critical-active',
		reference: '{red.300}',
		category: 'interactive',
		label: 'surface-critical-active',
	},
]
