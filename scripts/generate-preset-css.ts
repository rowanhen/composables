...
const presets: PresetDef[] = [
	...
	},
	{
		...
		description: "Raw, architectural, uncompromising. Structural honesty: things look exactly like what they are.",
		light: brutalist,
		dark: brutalistDark,
	},
	{
	...
	},
	{
		fileName: "swiss",
		displayName: "Swiss",
		description: "International Typographic Style. Absolute grid discipline, zero radius, zero shadow.",
		light: swiss,
		dark: swissDark,
	},
	{
